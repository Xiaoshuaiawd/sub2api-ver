export default {
  ...
  usage: {
    ...
    oauthCost: {
      title: 'OAuth Cost Accounting',
      description: 'Actual unit cost based on cumulative OAuth account consumption',
      purchaseCost: 'Purchase cost for OAuth accounts',
      consumedQuota: 'OAuth total consumed quota',
      unitCost: 'Actual cost per 1 quota',
      unitCostUnavailable: 'No consumed quota yet',
      accountCount: 'OAuth accounts',
      ...
      loadFailed: 'Failed to load OAuth cost data',
      retry: 'Retry',
      invalidPurchaseCost: 'Enter a valid amount greater than or equal to 0'
    },
