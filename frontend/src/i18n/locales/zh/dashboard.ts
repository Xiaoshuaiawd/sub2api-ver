export default {
  ...
  usage: {
    ...
    oauthCost: {
      title: 'OAuth 成本核算',
      description: '根据购买 OAuth 账号的花费计算每 1 额度实际成本',
      purchaseCost: '购买 OAuth 账号的花费',
      consumedQuota: 'OAuth 账号总消耗额度',
      unitCost: '每 1 额度实际成本',
      unitCostUnavailable: '暂无消耗额度，暂不计算单价',
      accountCount: 'OAuth 账号数',
      requests: '请求数',
      tokens: 'Token 数',
      save: '保存',
      saving: '保存中...',
      saved: '已保存',
      saveFailed: '保存失败',
      invalidPurchaseCost: '请输入大于或等于 0 的有效金额',
      loadFailed: '加载 OAuth 成本核算数据失败',
      retry: '重试'
    },
