export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiProxyTitle: 'Default OpenAI Egress Proxy',
        openaiProxyDescription: 'Applies only to OpenAI, ChatGPT, and Codex upstream requests. Account proxies take priority; this node proxy is used when no account proxy exists or its proxy chain fails.',
        openaiProxyEnabled: 'Enable the node default proxy',
        openaiProxyEnabledHint: 'Each Sub2API instance uses its own configured default proxy egress.',
        openaiProxyURL: 'Proxy URL',
        openaiProxyURLPlaceholder: 'socks5h://warp-proxy:1080',
        openaiProxyURLConfiguredPlaceholder: 'Proxy credentials are configured; enter a new URL to replace them',
        openaiProxyURLHint: 'Supports HTTP, HTTPS, SOCKS5, and SOCKS5H. For WARP, use socks5h://warp-proxy:1080.',
        openaiProxyFailurePolicy: 'Proxy failure policy',
        openaiProxyFailClosed: 'Block when proxies fail',
        openaiProxyFailClosedHint: 'Return an error when every proxy candidate is unavailable; never bypass the proxy.',
        openaiProxyFallbackDirect: 'Allow direct fallback',
        openaiProxyFallbackDirectHint: 'Try a direct connection from this node after every proxy candidate fails.',
        openaiProxyFallbackDirectWarning: "Direct fallback exposes the node's public IP. Enable it only when that risk is acceptable.",
        openaiProxyStatusTitle: 'Current node status',
        openaiProxyHealthy: 'Proxy egress healthy',
        openaiProxyUnhealthy: 'Proxy egress unhealthy',
        openaiProxyPending: 'Waiting for first check',
        openaiProxyInstance: 'Instance',
        openaiProxyEgressIP: 'Egress IP',
        openaiProxyCheckedAt: 'Checked at',
        openaiProxyUnavailable: 'Unavailable',
        ...
        openaiCodexUpstreamURL: 'Codex upstream endpoint',
        openaiCodexUpstreamURLPlaceholder: 'Leave empty to use https://chatgpt.com/backend-api/codex/responses',
        openaiCodexUpstreamURLHint: 'When set, Codex (OAuth account) Responses requests are sent to this URL verbatim: request body, headers and auth stay identical, only the target URL changes. Applies to both HTTP and WebSocket. Leave empty to use the official endpoint.',
