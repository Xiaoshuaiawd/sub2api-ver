export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiUpstreamRetryCount: 'OpenAI Same-Account Error Retries',
        openaiUpstreamRetryCountHint: 'Extra retries on the current account after an upstream error, from 0 to 10 (default 3). A 429 with an explicit cooldown skips retries and follows the existing account switch rule. Started streams are not retried.',
