export default {
    accounts: {
      ...
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      proxyRoutingDirect: 'Direct connection',
      proxyRoutingFixed: 'Fixed proxy',
      proxyRoutingGroup: 'Proxy group',
      proxyRoutingSelectGroup: 'Select a proxy group',
      proxyRoutingGroupHint: 'A random active proxy in this group is selected for each new request.',
