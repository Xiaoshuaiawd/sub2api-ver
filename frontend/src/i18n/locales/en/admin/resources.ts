export default {
    ...
    usage: {
      ...
      message: {
        ...
        view: 'View message bodies',
        request: 'Request body',
        response: 'Response body',
        expiresAt: 'Expires',
        loadFailed: 'Failed to load message bodies',
        copied: 'Body copied',
        retry: 'Retry',
        copy: 'Copy body',
        ...
        settingsSaved: 'Message body storage settings saved',
        settingsSaveFailed: 'Failed to save message body storage settings',
        stateLabels: {
          pending: 'Storing',
          available: 'Available',
          failed: 'Failed',
        ...
        states: {
          pending: 'The body is still being stored',
          available: 'The body is empty',
          failed: 'Body storage failed',
          partial: 'The client disconnected before the response completed',
          too_large: 'The body exceeds the configured storage limit',
          expired: 'The body was deleted by the retention policy',
          disabled: 'Message storage is disabled'
        }
      },
