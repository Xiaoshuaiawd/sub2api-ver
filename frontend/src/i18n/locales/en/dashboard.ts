export default {
  ...
  usage: {
    ...
    oauthCost: {
      ...
      description: 'Calculate the actual unit cost from purchased OAuth accounts',
      purchaseCost: 'OAuth account purchase cost',
      consumedQuota: 'Total consumed quota',
      unitCost: 'Actual cost per quota',
      ...
      loadFailed: 'Failed to load OAuth cost summary',
      retry: 'Retry'
    },
