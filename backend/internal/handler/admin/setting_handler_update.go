...
type UpdateSettingsRequest struct {
	...
	OpenAICodexUpstreamURL                 *string `json:"openai_codex_upstream_url"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		OpenAICodexUpstreamURL: func() string {
			if req.OpenAICodexUpstreamURL != nil {
				return strings.TrimSpace(*req.OpenAICodexUpstreamURL)
			}
			return previousSettings.OpenAICodexUpstreamURL
		}(),
	...
	payload := dto.SystemSettings{
		...
		OpenAICodexUpstreamURL:                                 updatedSettings.OpenAICodexUpstreamURL,
