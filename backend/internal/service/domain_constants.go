...
const (
	...
	SettingKeyOAuthPurchaseCostCNY        = "oauth_purchase_cost_cny"       // OAuth 账号采购成本（人民币/元）
	...
	// SettingKeyOpenAIUpstreamRetryCount OpenAI 上游失败后在当前账号额外重试的次数。
	SettingKeyOpenAIUpstreamRetryCount = "openai_upstream_retry_count"
