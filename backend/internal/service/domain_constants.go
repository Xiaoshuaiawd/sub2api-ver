...
const (
	...
	SettingKeyMessageStorageEnabled       = "message_storage_enabled"
	SettingKeyMessageStorageRetentionDays = "message_storage_retention_days"
	...
	// SettingKeyOpenCodeProtocolEnabled globally enables OpenCode HTTP identity normalization.
	SettingKeyOpenCodeProtocolEnabled = "opencode_protocol_enabled"
	// SettingKeyOpenCodeProtocolVersion selects the OpenCode version declared in User-Agent.
