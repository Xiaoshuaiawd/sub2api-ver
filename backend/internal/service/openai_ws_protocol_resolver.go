...
const (
	...
	// OpenAIUpstreamTransportResponsesWebsocketV2HTTPIngress requires an
	// HTTP /v1/responses bridge-compatible WSv2 account. Passthrough accounts
	// are excluded because they bypass the WS forwarder.
	OpenAIUpstreamTransportResponsesWebsocketV2HTTPIngress OpenAIUpstreamTransport = "responses_websockets_v2_http_ingress"
