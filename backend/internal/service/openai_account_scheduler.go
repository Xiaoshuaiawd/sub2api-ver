...
func (s *OpenAIGatewayService) isOpenAIAccountTransportCompatible(account *Account, requiredTransport OpenAIUpstreamTransport) bool {
	...
	if requiredTransport == OpenAIUpstreamTransportResponsesWebsocketV2HTTPIngress {
		if account.IsOpenAIPassthroughEnabled() || !account.SupportsOpenAIEndpointCapability(OpenAIEndpointCapabilityResponses) {
			return false
		}
