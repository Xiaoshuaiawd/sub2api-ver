...
func init() {
	...
	// proxyDescProxyGroup is the schema descriptor for proxy_group field.
	proxyDescProxyGroup := proxyFields[7].Descriptor()
	// proxy.ProxyGroupValidator is a validator for the "proxy_group" field. It is called by the builders before save.
	proxy.ProxyGroupValidator = proxyDescProxyGroup.Validators[0].(func(string) error)
